    ...
    return Container(
      ...
      child:
        ...
        children: [
          ...
          Image.asset("assets/images/img_19.png",width: 150,height: 150, opacity: const AlwaysStoppedAnimation(.5),),
          Text("¡¡Bienvenido!!",
            style: TextStyle(color: Colors.orange, fontSize: 25, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
          Container(
            padding: EdgeInsets.all(30),
            child:
            Text("Esta aplicación busca funcionar como una herramienta de apoyo para la creación de ambientes seguros y divertidos para los niños, y así formar mejores personas para el mundo.\nAdemás, de combatir la cultura consumista para dejar un mundo mejor para los pequeños",
      ...
      child: Row(
        children: [
          ...
          ClipRRect(
            ...
            child: Image.asset("assets/images/img_9.png",height: 120,),
          ),
